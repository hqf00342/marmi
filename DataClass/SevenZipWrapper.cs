...
namespace Marmi
{
	...
	public class SevenZipWrapper : IDisposable
	{
		...
		void evtExtractionFinished(object sender, EventArgs e)
		{
		...
		void evtFileExtractionFinished(object sender, FileInfoEventArgs e)
		{
			//ver1.10 キャンセル処理の追加
		...
		void evtExtracting(object sender, ProgressEventArgs e)
		{
			//ver1.10 キャンセル処理の追加
			//ただしここでのキャンセルは効かない模様。
